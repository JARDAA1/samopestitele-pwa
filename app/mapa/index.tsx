...
interface Pestitel {
  ...
  popis: string | null;
  telefon: string;
  produkty?: string[]; // názvy produktů od tohoto farmáře
}
...
export default function MapaScreen() {
  ...
  const distanceOptions = [5, 10, 20, 30, 50, 999999]; // 999999 = Neomezeně
  ...
  const loadPestitele = async () => {
    try {
      ...
      Alert.alert('Chyba', 'Nepodařilo se načíst farmáře');
    } finally {
      setLoading(false);
    }
  };
