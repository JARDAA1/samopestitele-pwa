...
const styles = StyleSheet.create({
  ...
  descriptionTitle: { fontSize: 16, fontWeight: 'bold', color: '#1a1a1a', marginBottom: 8 },
  ...
  officeHoursTitle: { fontSize: 16, fontWeight: 'bold', color: '#1a1a1a', marginBottom: 12 },
  officeHoursRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  productsTitle: { fontSize: 18, fontWeight: 'bold', color: '#1a1a1a', marginBottom: 15 },
  ...
  backButton: { backgroundColor: '#1a1a1a', paddingVertical: 12, paddingHorizontal: 24, borderRadius: 8 },
