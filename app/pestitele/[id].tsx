...
const styles = StyleSheet.create({
  ...
  descriptionTitle: { fontSize: 16, fontWeight: 'bold', color: '#33691e', marginBottom: 8 },
  ...
  officeHoursTitle: { fontSize: 16, fontWeight: 'bold', color: '#33691e', marginBottom: 12 },
  officeHoursRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  productsTitle: { fontSize: 18, fontWeight: 'bold', color: '#33691e', marginBottom: 15 },

  emptyState: { alignItems: 'center', padding: 40, marginTop: 20 },
  emptyIcon: { fontSize: 60, marginBottom: 15 },
  emptyTitle: { fontSize: 20, fontWeight: 'bold', color: '#33691e', marginBottom: 8 },
  ...
  backButton: { backgroundColor: '#33691e', paddingVertical: 12, paddingHorizontal: 24, borderRadius: 8 },
