...
import { useShoppingList } from '@/features/kosik/hooks/cartContext';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Menu Items */}
        <ScrollView style={styles.menuItems} showsVerticalScrollIndicator={false} bounces={false}>
          <TouchableOpacity
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => handleNavigate('/moje-objednavky')}
          >
            <Feather name="package" size={24} color="#333" style={styles.menuItemIcon} />
            <Text style={styles.menuItemText}>Moje objednávky</Text>
          </TouchableOpacity>
          ...
          {isAuthenticated && (
            <>
              ...
              >
                <Feather name="map-pin" size={24} color="#333" style={styles.menuItemIcon} />
                <Text style={styles.menuItemText}>Stánek</Text>
              </TouchableOpacity>
            </>
          )}
